...
Route::group(['prefix' => 'result'], function () {
    ...
    Route::any('/ambient_air_new/{id}', [ResultController::class, 'addAmbientAirNew'])->name('result.ambient_air.add_loc');
    Route::any('/noise/{id}', [ResultController::class, 'addNoise'])->name('result.noise');
    Route::any('/workplace_air/{id}', [ResultController::class, 'addWorkplaceAir'])->name('result.workplace_air');
    Route::any('/odor/{id}', [ResultController::class, 'addOdor'])->name('result.odor');
    Route::any('/illumination/{id}', [ResultController::class, 'addIllumination'])->name('result.illumination');
    Route::any('/heat_stress/{id}', [ResultController::class, 'addHeatStress'])->name('result.heat_stress');
    Route::any('/stationary_stack/{id}', [ResultController::class, 'addStationaryStack'])->name('result.stationary_stack');
