...
<ul class="nav nav-pills flex-column flex-sm-row mb-4">
        ...
        <li class="nav-item"><a class="nav-link active" href="{{ route('result.ambient_air.add_4', $institute->id) }}"><i
                    class="bx bx-current-location me-1"></i>
...
<div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
    ...
    @endif
    <form class="card" action="{{ route('result.add_sample_4', $institute->id) }}" method="POST">
        @csrf
        <div class="col-xl-12">
                ...
                <div class="row">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                @php
                                    $samplingData = $sampling ? $sampling->where('no_sample', '04')->where('institute_id', $institute->id)->first() : null;
                                @endphp
                                <td>
...
<div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
    ...
    @endif
    <form class="card" action="{{ route('result.ambient_air.add_4', $institute->id) }}" method="POST">
        @csrf
        <div class="col-xl-12">
            <div class="card-body">
                <div class="row">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <form class="card" action="{{ route('result.ambient_air.add_4', $institute->id) }}"
                                method="POST">
                                @csrf
    ...
    <form class="card" action="{{ route('result.ambient_air.add_4', $institute->id) }}" method="POST">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @php
                    $samplingData = $sampling ? $sampling->where('no_sample', '04')->where('institute_id',
