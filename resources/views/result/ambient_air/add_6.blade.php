...
<div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
    ...
    @endif
    <form class="card" action="{{ route('result.add_sample_6', $institute->id) }}" method="POST">
        @csrf
        <div class="col-xl-12">
            ...
            <div class="card-body">
                <div class="row">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <form class="card" action="{{ route('result.ambient_air.add_6', $institute->id) }}"
                                method="POST">
                                @csrf
...
<div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
    <form class="card" id="mainForm" action="{{ route('result.ambient_air.add_6', $institute->id) }}" method="POST">
        @csrf
        <div class="col-xl-12">
            <div class="card-body">
                <div class="row">
