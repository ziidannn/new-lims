                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td colspan="3">
                                ...
                                <!-- Tabel tanpa garis -->
                                @php
                                    $fieldCondition = $fieldCondition->first(); // Ambil satu data terakhir
                                @endphp
                                <table style="border-collapse: collapse; width: 100%;">
                                    <tr style="border: none;">
                                        <td style="width: 10%; padding: 5px; border: none;">
                                        ...
                                        <td style="border: none;">
                                            <input type="text" class="form-control" maxlength="120" name="coordinate"
                                                ...
                                                value="{{ old('coordinate', optional($fieldCondition)->coordinate) }}">
                                            <input type="hidden" name="result_id"
                                                value="{{ optional($fieldCondition)->result_id }}">
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="border: none;">
                                        ...
                                        <td style="border: none;">
                                            <input type="text" class="form-control" maxlength="120" name="temperature"
                                                ...
                                                value="{{ old('temperature', optional($fieldCondition)->temperature) }}">
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="border: none;">
                                        ...
                                        <td style="border: none;">
                                            <input type="text" class="form-control" maxlength="120" name="pressure"
                                                ...
                                                value="{{ old('pressure', optional($fieldCondition)->pressure) }}">
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="border: none;">
                                        ...
                                        <td style="border: none;">
                                            <input type="text" class="form-control" maxlength="120" name="humidity"
                                                ...
                                                value="{{ old('humidity', optional($fieldCondition)->humidity) }}">
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="border: none;">
                                        ...
                                        <td style="border: none;">
                                            <input type="text" class="form-control" maxlength="120" name="wind_speed"
                                                ...
                                                value="{{ old('wind_speed', optional($fieldCondition)->wind_speed) }}">
                                        </td>
                                    </tr>

                                    <tr style="border: none;">
                                        <td style="width: 10%; padding: 5px; border: none;">
                                            <label class="form-label" for="wind_direction">Wind Direction:</label>
                                        </td>
                                        <td style="border: none;">
                                            <input type="text" class="form-control" maxlength="120" name="wind_direction"
                                                placeholder="Input Wind Direction"
                                                value="{{ old('wind_direction', optional($fieldCondition)->wind_direction) }}">
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="border: none;">
                                        ...
                                        <td style="border: none;">
                                            <input type="text" class="form-control" maxlength="120" name="weather"
                                                ...
                                                value="{{ old('weather', optional($fieldCondition)->weather) }}">
                                        </td>
                                    </tr>
                                </table>
