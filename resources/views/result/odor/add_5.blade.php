...
<div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
        ...
        <li class="nav-item"><a class="nav-link active" href="{{ route('result.workplace.add_6', $institute->id) }}"><i
                    class="bx bx-current-location me-1"></i>
...
<div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
    <form class="card" action="{{ route('result.workplace.add_5', $institute->id) }}" method="POST">
        @csrf
        <div class="col-xl-12">
            <div class="card-body">
                <div class="row">
                    <table class="table table-bordered" id="parameterTable">
                        ...
                        <tr>
                            <form class="card" action="{{ route('result.workplace.add_5', $institute->id) }}"
                                method="POST">
                                @csrf
