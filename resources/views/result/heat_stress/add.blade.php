                    ...
                    <table class="table table-bordered" id="locationTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" name="heat_stress_id[]" value="{{ isset($existingHeatStress[$i]) ? $existingHeatStress[$i]->id : '' }}">
...
<div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
    <form class="card" id="mainForm" action="{{ route('result.heat_stress.add', $instituteSubject->id) }}" method="POST">
        @csrf
        <div class="col-xl-12">
            <div class="card-body">
                <div class="row">
