...
<div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
    ...
    @endif
    <form class="card" action="{{ route('result.add_sample_1', $institute->id) }}" method="POST">
        @csrf
        <div class="col-xl-12">
...
<div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
    <form class="card" action="{{ route('result.workplace.add_1', $institute->id) }}" method="POST">
        @csrf
        <div class="col-xl-12">
            <div class="card-body">
                <div class="row">
                    <table class="table table-bordered" id="parameterTable">
                        ...
                        <tr>
                            <form class="card" action="{{ route('result.workplace.add_1', $institute->id) }}"
                                method="POST">
                                @csrf
